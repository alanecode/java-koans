...
public class AboutStrings {
    ...
    public void implicitStrings() {
    	// AL: this is an example of a class literal https://docs.oracle.com/javase/7/docs/api/java/lang/Class.html
    ...
    public void stringCompare() {
    	// AL: compareTo compares strings lexographically, returning 0 if they are equal
        String str = "I AM a number ONE!";
